...
bp1 <- barplot(co2_levels, main = "Carbon-dioxide levels through the years", xlab = "Years Before Today", ylab = "CO2 (in ppm)", names.arg = years, col = c("lightcyan", "red", "lightblue"),)
...
plt1 <- plot(co2_levels, type = "l", xlab = "Years (in 100s)", ylab = "CO2 (in ppm)", main = "Increasing CO2 levels", col  = rainbow(25))
...
gplt1 <- ggplot(df1, aes(cities, temperature1, fill = year)) + ggtitle("Mean Temperature in December") +  geom_bar(stat="identity", position = "dodge") +  scale_fill_brewer(palette = "Set1") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Cities") + ylab("Temperature")
...
```{r, echo=FALSE, results='hide', fig.align="center"}
gplt2 <- ggplot(df2, aes(cities, temperature2, fill = year)) + ggtitle("Mean Temperature in June") + geom_bar(stat="identity", position = "dodge") +  scale_fill_brewer(palette = "Set1") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Cities") + ylab("Temperature")
...
gplt3 <- ggplot(df1, aes(cities, rainfall1, fill = year)) + ggtitle("Rainfall in December (in mm)") +  geom_bar(stat="identity", position = "dodge") +  scale_fill_brewer(palette = "Set1") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Cities") + ylab("Rainfall (mm)")
...
&nbsp;
```{r, echo=FALSE, results='hide', fig.align="center"}
gplt4 <- ggplot(df2, aes(cities, rainfall2, fill = year)) + ggtitle("Rainfall in June (in mm)") + geom_bar(stat="identity", position = "dodge") +  scale_fill_brewer(palette = "Set1") + theme(plot.title = element_text(hjust = 0.5)) + xlab("Cities") + ylab("Rainfall (mm)")
...
```{r, echo=FALSE, results='hide', fig.align="center"}
  ...
  bplt2 <- barplot(drought$Number.of.reported.natural.disasters..reported.disasters., names.arg = drought$Year, xlab = "Year", ylab = "# of Droughts", main = "Droughts across the world", col = c("lightcyan", "red", "lightblue"),)
...
```{r, echo=FALSE, results='hide', fig.align="center"}
bplt3 <- barplot(flood$Number.of.reported.natural.disasters..reported.disasters., names.arg = flood$Year, xlab = "Year", ylab = "# of Floods", main = "Floods across the world", col = c("lightcyan", "red", "lightblue"),)
